function Strings( config ) {
	...
	const values = {
		...
		es: {
			...
			'prompt/file/open': '¿Se perderán todos los datos no guardados. ¿Estás seguro?',
			'prompt/file/failedToOpenProject': '¡Error al abrir el proyecto!',
			'prompt/file/export/noMeshSelected': '¡No se ha seleccionado ninguna malla!',
			'prompt/file/export/noObjectSelected': '¡No se ha seleccionado ningún objeto!',
			'prompt/script/remove': '¿Estás seguro?',
			'prompt/history/clear': 'El historial de Deshacer/Rehacer será borrado. ¿Estás seguro?',
			'prompt/history/preserve': 'El historial se conservará entre sesiones.\nEsto puede tener un impacto en el rendimiento al trabajar con texturas.',
			'prompt/history/forbid': 'Deshacer/Rehacer deshabilitado mientras la escena se reproduce.',
			'prompt/rendering/realistic/unsupportedMaterial': 'Sombreado REALISTA: Solo MeshStandardMaterial y MeshPhysicalMaterial son compatibles',

			'command/AddObject': 'Agregar Objeto',
			'command/AddScript': 'Agregar Script',
			'command/MoveObject': 'Mover Objeto',
			'command/MultiCmds': 'Múltiples Cambios',
			'command/RemoveObject': 'Eliminar Objeto',
			'command/RemoveScript': 'Eliminar Script',
			'command/SetColor': 'Establecer Color',
			'command/SetGeometry': 'Establecer Geometría',
			'command/SetGeometryValue': 'Establecer Valor de Geometría',
			'command/SetMaterialColor': 'Establecer Color de Material',
			'command/SetMaterial': 'Establecer Material',
			'command/SetMaterialMap': 'Establecer Mapa de Material',
			'command/SetMaterialRange': 'Establecer Rango de Material',
			'command/SetMaterialValue': 'Establecer Valor de Material',
			'command/SetMaterialVector': 'Establecer Vector de Material',
			'command/SetPosition': 'Establecer Posición',
			'command/SetRotation': 'Establecer Rotación',
			'command/SetScale': 'Establecer Escala',
			'command/SetScene': 'Establecer Escena',
			'command/SetScriptValue': 'Establecer Valor de Script',
			'command/SetShadowValue': 'Establecer Valor de Sombra',
			'command/SetUuid': 'Establecer UUID',
			'command/SetValue': 'Establecer Valor',

			'menubar/file': 'Archivo',
			'menubar/file/new': 'Nuevo',
			'menubar/file/new/empty': 'Vacío',
			'menubar/file/new/Arkanoid': 'Arkanoid',
			'menubar/file/new/Camera': 'Cámara',
			'menubar/file/new/Particles': 'Partículas',
			'menubar/file/new/Pong': 'Pong',
			'menubar/file/new/Shaders': 'Shaders',
			'menubar/file/open': 'Abrir',
			'menubar/file/save': 'Guardar',
			'menubar/file/import': 'Importar',
			'menubar/file/export': 'Exportar',

			'menubar/edit': 'Editar',
			'menubar/edit/undo': 'Deshacer',
			'menubar/edit/redo': 'Rehacer',
			'menubar/edit/center': 'Centrar',
			'menubar/edit/clone': 'Clonar',
			'menubar/edit/delete': 'Eliminar',

			'menubar/add': 'Agregar',
			'menubar/add/group': 'Grupo',

			'menubar/add/mesh': 'Malla',
			'menubar/add/mesh/plane': 'Plano',
			'menubar/add/mesh/box': 'Caja',
			'menubar/add/mesh/capsule': 'Cápsula',
			'menubar/add/mesh/circle': 'Círculo',
			'menubar/add/mesh/cylinder': 'Cilindro',
			'menubar/add/mesh/ring': 'Anillo',
			'menubar/add/mesh/sphere': 'Esfera',
			'menubar/add/mesh/dodecahedron': 'Dodecaedro',
			'menubar/add/mesh/icosahedron': 'Icosaedro',
			'menubar/add/mesh/octahedron': 'Octaedro',
			'menubar/add/mesh/tetrahedron': 'Tetraedro',
			'menubar/add/mesh/torus': 'Toro',
			'menubar/add/mesh/tube': 'Tubo',
			'menubar/add/mesh/torusknot': 'Nudo Toro',
			'menubar/add/mesh/lathe': 'Torno',
			'menubar/add/mesh/sprite': 'Sprite',

			'menubar/add/light': 'Luz',
			'menubar/add/light/ambient': 'Ambiental',
			'menubar/add/light/directional': 'Direccional',
			'menubar/add/light/hemisphere': 'Hemisferio',
			'menubar/add/light/point': 'Punto',
			'menubar/add/light/spot': 'Foco',

			'menubar/add/camera': 'Cámara',
			'menubar/add/camera/perspective': 'Perspectiva',
			'menubar/add/camera/orthographic': 'Ortográfica',

			'menubar/status/autosave': 'guardado automático',

			'menubar/view': 'Ver',
			'menubar/view/fullscreen': 'Pantalla Completa',
			'menubar/view/gridHelper': 'Ayudante de Cuadrícula',
			'menubar/view/cameraHelpers': 'Ayudantes de Cámara',
			'menubar/view/lightHelpers': 'Ayudantes de Luz',
			'menubar/view/skeletonHelpers': 'Ayudantes de Esqueleto',

			'menubar/help': 'Ayuda',
			'menubar/help/source_code': 'Código Fuente',
			'menubar/help/icons': 'Pack de Iconos',
			'menubar/help/about': 'Acerca de',
			'menubar/help/manual': 'Manual',

			'sidebar/animations': 'Animaciones',
			'sidebar/animations/play': 'Reproducir',
			'sidebar/animations/stop': 'Detener',
			'sidebar/animations/timescale': 'Escala de Tiempo',

			'sidebar/scene': 'Escena',
			'sidebar/scene/background': 'Fondo',
			'sidebar/scene/environment': 'Entorno',
			'sidebar/scene/fog': 'Niebla',

			'sidebar/properties/object': 'Objeto',
			'sidebar/properties/geometry': 'Geometría',
			'sidebar/properties/material': 'Material',
			'sidebar/properties/script': 'Script',

			'sidebar/object/type': 'Tipo',
			'sidebar/object/new': 'Nuevo',
			'sidebar/object/uuid': 'UUID',
			'sidebar/object/name': 'Nombre',
			'sidebar/object/position': 'Posición',
			'sidebar/object/rotation': 'Rotación',
			'sidebar/object/scale': 'Escala',
			'sidebar/object/fov': 'Campo de Visión',
			'sidebar/object/left': 'Izquierda',
			'sidebar/object/right': 'Derecha',
			'sidebar/object/top': 'Arriba',
			'sidebar/object/bottom': 'Abajo',
			'sidebar/object/near': 'Cerca',
			'sidebar/object/far': 'Lejos',
			'sidebar/object/intensity': 'Intensidad',
			'sidebar/object/color': 'Color',
			'sidebar/object/groundcolor': 'Color del Suelo',
			'sidebar/object/distance': 'Distancia',
			'sidebar/object/angle': 'Ángulo',
			'sidebar/object/penumbra': 'Penumbra',
			'sidebar/object/decay': 'Decaimiento',
			'sidebar/object/shadow': 'Sombra',
			'sidebar/object/shadowIntensity': 'Intensidad de Sombra',
			'sidebar/object/shadowBias': 'Sesgo de Sombra',
			'sidebar/object/shadowNormalBias': 'Sesgo Normal de Sombra',
			'sidebar/object/shadowRadius': 'Radio de Sombra',
			'sidebar/object/cast': 'proyectar',
			'sidebar/object/receive': 'recibir',
			'sidebar/object/visible': 'Visible',
			'sidebar/object/frustumcull': 'Recorte de Frustum',
			'sidebar/object/renderorder': 'Orden de Renderizado',
			'sidebar/object/userdata': 'Datos de usuario',
			'sidebar/object/export': 'Exportar JSON',

			'sidebar/geometry/type': 'Tipo',
			'sidebar/geometry/new': 'Nueva',
			'sidebar/geometry/uuid': 'UUID',
			'sidebar/geometry/name': 'Nombre',
			'sidebar/geometry/bounds': 'Límites',
			'sidebar/geometry/userdata': 'Datos de Usuario',
			'sidebar/geometry/show_vertex_normals': 'Mostrar Normales de Vértice',
			'sidebar/geometry/compute_vertex_normals': 'Calcular Normales de Vértice',
			'sidebar/geometry/compute_vertex_tangents': 'Calcular Tangentes',
			'sidebar/geometry/center': 'Centrar',
			'sidebar/geometry/export': 'Exportar JSON',

			'sidebar/geometry/box_geometry/width': 'Ancho',
			'sidebar/geometry/box_geometry/height': 'Alto',
			'sidebar/geometry/box_geometry/depth': 'Profundidad',
			'sidebar/geometry/box_geometry/widthseg': 'Seg. Ancho',
			'sidebar/geometry/box_geometry/heightseg': 'Seg. Alto',
			'sidebar/geometry/box_geometry/depthseg': 'Seg. Profundidad',

			'sidebar/geometry/buffer_geometry/attributes': 'Atributos',
			'sidebar/geometry/buffer_geometry/index': 'índice',
			'sidebar/geometry/buffer_geometry/morphAttributes': 'Atributos Morph',
			'sidebar/geometry/buffer_geometry/morphRelative': 'Morph Relativo',

			'sidebar/geometry/capsule_geometry/radius': 'Radio',
			'sidebar/geometry/capsule_geometry/length': 'Longitud',
			'sidebar/geometry/capsule_geometry/capseg': 'Seg. Tapa',
			'sidebar/geometry/capsule_geometry/radialseg': 'Seg. Radial',

			'sidebar/geometry/circle_geometry/radius': 'Radio',
			'sidebar/geometry/circle_geometry/segments': 'Segmentos',
			'sidebar/geometry/circle_geometry/thetastart': 'Inicio Theta',
			'sidebar/geometry/circle_geometry/thetalength': 'Longitud Theta',

			'sidebar/geometry/cylinder_geometry/radiustop': 'Radio superior',
			'sidebar/geometry/cylinder_geometry/radiusbottom': 'Radio inferior',
			'sidebar/geometry/cylinder_geometry/height': 'Alto',
			'sidebar/geometry/cylinder_geometry/radialsegments': 'Segmentos radiales',
			'sidebar/geometry/cylinder_geometry/heightsegments': 'Segmentos de altura',
			'sidebar/geometry/cylinder_geometry/openended': 'Extremos abiertos',

			'sidebar/geometry/extrude_geometry/curveSegments': 'Segmentos de Curva',
			'sidebar/geometry/extrude_geometry/steps': 'Pasos',
			'sidebar/geometry/extrude_geometry/depth': 'Profundidad',
			'sidebar/geometry/extrude_geometry/bevelEnabled': 'Bisel',
			'sidebar/geometry/extrude_geometry/bevelThickness': 'Grosor',
			'sidebar/geometry/extrude_geometry/bevelSize': 'Tamaño',
			'sidebar/geometry/extrude_geometry/bevelOffset': 'Desplazamiento',
			'sidebar/geometry/extrude_geometry/bevelSegments': 'Segmentos',
			'sidebar/geometry/extrude_geometry/shape': 'Convertir a Forma',

			'sidebar/geometry/dodecahedron_geometry/radius': 'Radio',
			'sidebar/geometry/dodecahedron_geometry/detail': 'Detalle',

			'sidebar/geometry/icosahedron_geometry/radius': 'Radio',
			'sidebar/geometry/icosahedron_geometry/detail': 'Detalle',

			'sidebar/geometry/octahedron_geometry/radius': 'Radio',
			'sidebar/geometry/octahedron_geometry/detail': 'Detalle',

			'sidebar/geometry/tetrahedron_geometry/radius': 'Radio',
			'sidebar/geometry/tetrahedron_geometry/detail': 'Detalle',

			'sidebar/geometry/lathe_geometry/segments': 'Segmentos',
			'sidebar/geometry/lathe_geometry/phistart': 'Inicio Phi (°)',
			'sidebar/geometry/lathe_geometry/philength': 'Longitud Phi (°)',
			'sidebar/geometry/lathe_geometry/points': 'Puntos',

			'sidebar/geometry/plane_geometry/width': 'Ancho',
			'sidebar/geometry/plane_geometry/height': 'Alto',
			'sidebar/geometry/plane_geometry/widthsegments': 'Segmentos de ancho',
			'sidebar/geometry/plane_geometry/heightsegments': 'Segmentos de altura',

			'sidebar/geometry/ring_geometry/innerRadius': 'Radio interior',
			'sidebar/geometry/ring_geometry/outerRadius': 'Radio exterior',
			'sidebar/geometry/ring_geometry/thetaSegments': 'Segmentos Theta',
			'sidebar/geometry/ring_geometry/phiSegments': 'Segmentos Phi',
			'sidebar/geometry/ring_geometry/thetastart': 'Inicio Theta',
			'sidebar/geometry/ring_geometry/thetalength': 'Longitud Theta',

			'sidebar/geometry/shape_geometry/curveSegments': 'Segmentos de Curva',
			'sidebar/geometry/shape_geometry/extrude': 'Extruir',

			'sidebar/geometry/sphere_geometry/radius': 'Radio',
			'sidebar/geometry/sphere_geometry/widthsegments': 'Segmentos de ancho',
			'sidebar/geometry/sphere_geometry/heightsegments': 'Segmentos de altura',
			'sidebar/geometry/sphere_geometry/phistart': 'Inicio Phi',
			'sidebar/geometry/sphere_geometry/philength': 'Longitud Phi',
			'sidebar/geometry/sphere_geometry/thetastart': 'Inicio Theta',
			'sidebar/geometry/sphere_geometry/thetalength': 'Longitud Theta',

			'sidebar/geometry/torus_geometry/radius': 'Radio',
			'sidebar/geometry/torus_geometry/tube': 'Tubo',
			'sidebar/geometry/torus_geometry/radialsegments': 'Segmentos radiales',
			'sidebar/geometry/torus_geometry/tubularsegments': 'Segmentos tubulares',
			'sidebar/geometry/torus_geometry/arc': 'Arco',

			'sidebar/geometry/torusKnot_geometry/radius': 'Radio',
			'sidebar/geometry/torusKnot_geometry/tube': 'Tubo',
			'sidebar/geometry/torusKnot_geometry/tubularsegments': 'Segmentos tubulares',
			'sidebar/geometry/torusKnot_geometry/radialsegments': 'Segmentos radiales',
			'sidebar/geometry/torusKnot_geometry/p': 'P',
			'sidebar/geometry/torusKnot_geometry/q': 'Q',

			'sidebar/geometry/tube_geometry/path': 'Ruta',
			'sidebar/geometry/tube_geometry/radius': 'Radio',
			'sidebar/geometry/tube_geometry/tube': 'Tubo',
			'sidebar/geometry/tube_geometry/tubularsegments': 'Segmentos tubulares',
			'sidebar/geometry/tube_geometry/radialsegments': 'Segmentos radiales',
			'sidebar/geometry/tube_geometry/closed': 'Cerrado',
			'sidebar/geometry/tube_geometry/curvetype': 'Tipo de Curva',
			'sidebar/geometry/tube_geometry/tension': 'Tensión',

			'sidebar/material/new': 'Nuevo',
			'sidebar/material/copy': 'Copiar',
			'sidebar/material/paste': 'Pegar',
			'sidebar/material/slot': 'Ranura',
			'sidebar/material/type': 'Tipo',
			'sidebar/material/uuid': 'UUID',
			'sidebar/material/name': 'Nombre',
			'sidebar/material/program': 'Programa',
			'sidebar/material/info': 'Info',
			'sidebar/material/vertex': 'Vert',
			'sidebar/material/fragment': 'Frag',
			'sidebar/material/color': 'Color',
			'sidebar/material/depthPacking': 'Empaquetado de Profundidad',
			'sidebar/material/roughness': 'Rugosidad',
			'sidebar/material/metalness': 'Metalizado',
			'sidebar/material/reflectivity': 'Reflectividad',
			'sidebar/material/emissive': 'Emisivo',
			'sidebar/material/specular': 'Especular',
			'sidebar/material/shininess': 'Brillo',
			'sidebar/material/clearcoat': 'Capa Transparente',
			'sidebar/material/clearcoatroughness': 'Rugosidad de Capa Transparente',
			'sidebar/material/dispersion': 'Dispersión',
			'sidebar/material/ior': 'IOR',
			'sidebar/material/iridescence': 'Iridiscencia',
			'sidebar/material/iridescenceIOR': 'IOR de Película Delgada',
			'sidebar/material/iridescenceThicknessMax': 'Grosor de Película Delgada',
			'sidebar/material/sheen': 'Brillo Superficial',
			'sidebar/material/sheenroughness': 'Rugosidad de Brillo Superficial',
			'sidebar/material/sheencolor': 'Color de Brillo Superficial',
			'sidebar/material/transmission': 'Transmisión',
			'sidebar/material/attenuationDistance': 'Distancia de Atenuación',
			'sidebar/material/attenuationColor': 'Color de Atenuación',
			'sidebar/material/thickness': 'Grosor',
			'sidebar/material/vertexcolors': 'Colores de Vértice',
			'sidebar/material/matcap': 'Matcap',
			'sidebar/material/map': 'Mapa',
			'sidebar/material/alphamap': 'Mapa Alfa',
			'sidebar/material/bumpmap': 'Mapa de Relieve',
			'sidebar/material/normalmap': 'Mapa Normal',
			'sidebar/material/clearcoatmap': 'Mapa de Capa Transparente',
			'sidebar/material/clearcoatnormalmap': 'Mapa Normal de Capa Transparente',
			'sidebar/material/clearcoatroughnessmap': 'Mapa de Rugosidad de Capa Transparente',
			'sidebar/material/displacementmap': 'Mapa de Desplazamiento',
			'sidebar/material/roughnessmap': 'Mapa de Rugosidad',
			'sidebar/material/metalnessmap': 'Mapa de Metalizado',
			'sidebar/material/specularmap': 'Mapa Especular',
			'sidebar/material/iridescencemap': 'Mapa de Iridiscencia',
			'sidebar/material/iridescencethicknessmap': 'Mapa de Grosor de Película Delgada',
			'sidebar/material/sheencolormap': 'Mapa de Color de Brillo Superficial',
			'sidebar/material/sheenroughnessmap': 'Mapa de Rugosidad de Brillo Superficial',
			'sidebar/material/envmap': 'Mapa de Entorno',
			'sidebar/material/lightmap': 'Mapa de Luz',
			'sidebar/material/aomap': 'Mapa AO',
			'sidebar/material/emissivemap': 'Mapa Emisivo',
			'sidebar/material/gradientmap': 'Mapa de Gradiente',
			'sidebar/material/transmissionmap': 'Mapa de Transmisión',
			'sidebar/material/thicknessmap': 'Mapa de Grosor',
			'sidebar/material/side': 'Lado',
			'sidebar/material/size': 'Tamaño',
			'sidebar/material/sizeAttenuation': 'Atenuación de Tamaño',
			'sidebar/material/flatShading': 'Sombreado Plano',
			'sidebar/material/blending': 'Mezcla',
			'sidebar/material/opacity': 'Opacidad',
			'sidebar/material/transparent': 'Transparente',
			'sidebar/material/forcesinglepass': 'Forzar Pase Único',
			'sidebar/material/alphatest': 'Prueba Alfa',
			'sidebar/material/depthtest': 'Prueba de Profundidad',
			'sidebar/material/depthwrite': 'Escritura de Profundidad',
			'sidebar/material/wireframe': 'Estructura de Alambre',
			'sidebar/material/userdata': 'Datos de usuario',
			'sidebar/material/export': 'Exportar JSON',

			'sidebar/script/new': 'Nuevo',
			'sidebar/script/edit': 'Editar',
			'sidebar/script/remove': 'Eliminar',

			'sidebar/project': 'Proyecto',
			'sidebar/project/antialias': 'Suavizado',
			'sidebar/project/shadows': 'Sombras',
			'sidebar/project/toneMapping': 'Mapeo de Tonos',
			'sidebar/project/materials': 'Materiales',
			'sidebar/project/Assign': 'Asignar',

			'sidebar/project/app': 'Aplicación',
			'sidebar/project/app/play': 'Reproducir',
			'sidebar/project/app/stop': 'Detener',
			'sidebar/project/app/title': 'Título',
			'sidebar/project/app/editable': 'Editable',
			'sidebar/project/app/publish': 'Publicar',

			'sidebar/project/image': 'Imagen',
			'sidebar/project/image/samples': 'Muestras',
			'sidebar/project/video': 'Video',

			'sidebar/project/shading': 'Sombreado',
			'sidebar/project/resolution': 'Resolución',
			'sidebar/project/duration': 'Duración',
			'sidebar/project/render': 'Renderizar',

			'sidebar/settings': 'Configuración',
			'sidebar/settings/language': 'Idioma',

			'sidebar/settings/shortcuts': 'Atajos',
			'sidebar/settings/shortcuts/translate': 'Trasladar',
			'sidebar/settings/shortcuts/rotate': 'Rotar',
			'sidebar/settings/shortcuts/scale': 'Escalar',
			'sidebar/settings/shortcuts/undo': 'Deshacer',
			'sidebar/settings/shortcuts/focus': 'Enfocar',

			'sidebar/history': 'Historial',
			'sidebar/history/clear': 'Limpiar',
			'sidebar/history/persistent': 'Persistente',

			'toolbar/translate': 'Trasladar',
			'toolbar/rotate': 'Rotar',
			'toolbar/scale': 'Escalar',
			'toolbar/local': 'Local',

			'viewport/controls/grid': 'Cuadrícula',
			'viewport/controls/helpers': 'Ayudantes',

			'viewport/info/object': 'Objeto',
			'viewport/info/objects': 'Objetos',
			'viewport/info/vertex': 'Vértice',
			'viewport/info/vertices': 'Vértices',
			'viewport/info/triangle': 'Triángulo',
			'viewport/info/triangles': 'Triángulos',
			'viewport/info/sample': 'Muestra',
			'viewport/info/samples': 'Muestras',
			'viewport/info/rendertime': 'Tiempo de renderizado',

			'script/title/vertexShader': 'Shader de Vértices',
			'script/title/fragmentShader': 'Shader de Fragmentos',
			'script/title/programInfo': 'Propiedades del Programa'
